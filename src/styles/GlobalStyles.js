...
import darker_grotesque_v2_latin_500_woff from '@static/fonts/Darker_Grotesque/darker-grotesque-v2-latin-500.woff'
import darker_grotesque_v2_latin_800_woff2 from '@static/fonts/Darker_Grotesque/darker-grotesque-v2-latin-800.woff2'
import darker_grotesque_v2_latin_800_woff from '@static/fonts/Darker_Grotesque/darker-grotesque-v2-latin-800.woff'
...
@font-face {
  ...
  font-style: normal;
  font-weight: 500;
  src: local(''), url(${darker_grotesque_v2_latin_500_woff2}) format('woff2'),
    url(${darker_grotesque_v2_latin_500_woff}) format('woff');
...
@font-face {
  ...
  font-style: normal;
  font-weight: 800;
  src: local(''), url(${darker_grotesque_v2_latin_800_woff2}) format('woff2'),
    url(${darker_grotesque_v2_latin_800_woff}) format('woff');
  font-display: fallback;
}
